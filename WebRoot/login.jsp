  ...
  <head>
    ...
    <script language="javascript">
		...
		{                                                                                         
			 ...
			 loginService.login(document.ThisForm.userName.value,document.ThisForm.userPw.value,leixing1,callback11);
...
<div class="main-login">
	<div class="login-content">	
	    <h2 style="font-size: 18px;">iwork cloud管理系统</h2>
	    ...
	    <form action="<%=path %>/admin/index.jsp" method="post" name="ThisForm">
		    ...
		    <div class="login-info">
				<span class="pwd">&nbsp;</span>
				<input name="userPw" type="password" class="login-input"/>
			</div>
			<div class="login-info">
				<span class="pwd">&nbsp;</span>
				<input type="radio" name="leixing" value="0" checked="checked"/>系统管理员
				&nbsp;
				<input type="radio" name="leixing" value="2"/>员工
				&nbsp;
			</div>
		    <div class="login-oper">
				<input name="" type="button" value="登 录" class="login-btn" style="margin-left: 50px;" onclick="ccc()"/>
